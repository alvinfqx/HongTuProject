			...
			if(data.length == 0) {
				...
				$.each(data, function(i, n) {
					...
					for(var j = 0; j < aw_relist_imgdata.length; j++) {
						time_html += '<img src="' + aw_relist_imgdata[j].fileStorePath + '"alt="..." class="margin" style="width: 150px;height: 100px;">'
					}
					time_html += '</div>'
					time_html += '</div>'
					time_html += '</li>'
	...
	cm.ajax({
		...
		success: function(data) {
			...
			$.each(data, function(i, n) {
				...
				// console.log(aw_relist_imgdata.length)
		...
		success: function(data) {
			...
			cm.ajax({
				...
				success: function(data2) {
					...
					initvalue = data.baseEntity.serviceStaff;
					//  initvalue = initvalue + ",System,ccccccc," + data.baseEntity.serviceStaff + ",";
