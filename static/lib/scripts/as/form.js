...
$(function() {
	...
	var myDropzone = new Dropzone("#selfSolutioDesc", {
		...
		url: " /AfterSaleManage/aw_workinfo/BatchUpload?keyValue=111&tbname=aw_selfhelp_so_attachment&token=" + cm.token, //文件提交地址
		method: "post", //也可用put
			...
			this.on("removedfile", function(file) {
				...
				if(file_id) {
					$.post(' /AfterSaleManage/aw_workinfo/BatchDelete?keyValue=' + file.name, {
						'tbname': 'aw_selfhelp_so_attachment'
					}, function(data) {
	...
	var myDropzone = new Dropzone("#dropzone1", {
		// url: "/admin/upload",//文件提交地址
		url: " /AfterSaleManage/aw_workinfo/BatchUpload?keyValue=111&tbname=aw_requirement_attachment&token=" + cm.token, //文件提交地址
		method: "post", //也可用put
		paramName: "file", //默认为file
		maxFiles: 10, //一次性上传的文件数量上限
		// maxFilesize: 2, //文件大小，单位：MB
	...
	var myDropzone = new Dropzone("#dropzoneSolution", {
		// url: "/admin/upload",//文件提交地址
		url: "  /AfterSaleManage/aw_workinfo/BatchUpload?keyValue=111&tbname=aw_solution_attachment&token=" + cm.token, //文件提交地址
		method: "post", //也可用put
		paramName: "file", //默认为file
		maxFiles: 10, //一次性上传的文件数量上限
		// maxFilesize: 2, //文件大小，单位：MB
	...
	var myDropzone = new Dropzone("#dropzoneCause", {
		// url: "/admin/upload",//文件提交地址
		url: "  /AfterSaleManage/aw_workinfo/BatchUpload?keyValue=111&tbname=aw_cause_attachment&token=" + cm.token, //文件提交地址
		method: "post", //也可用put
		paramName: "file", //默认为file
		maxFiles: 10, //一次性上传的文件数量上限
		// maxFilesize: 2, //文件大小，单位：MB
	...
	var myDropzone = new Dropzone("#dropzoneDesc", {
		// url: "/admin/upload",//文件提交地址
		url: "  /AfterSaleManage/aw_workinfo/BatchUpload?keyValue=111&tbname=aw_serviceDesc_attachment&token=" + cm.token, //文件提交地址
		method: "post", //也可用put
		paramName: "file", //默认为file
		maxFiles: 10, //一次性上传的文件数量上限
		// maxFilesize: 2, //文件大小，单位：MB
...
function GetProgress() {
	// alert("progress info jefffffeafeaweff");
	cm.ajax({
