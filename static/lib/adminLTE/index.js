	...
	tablist = {
		...
		newTab: function(item) {
			...
			if(flag) {
				...
				var str1 = '<iframe class="LRADMS_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="../..' + dataUrl + '.html" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
...
console.log($(this))
	...
	$.learunindex = {
		...
		loadMenu: function() {
			...
			console.log(data);
			page_parameters.MenuData = authorizeMenuData;
			var _html = "";
						...
						$.each(childNodes, function(i) {
							...
							if(subchildNodes.length > 0) {
								...
								$.each(subchildNodes, function(i) {
									...
									_html += '<li><a class="menuItem" data-id="' + subchildNodesrow.ModuleId + '" href="../..' + subchildNodesrow.UrlAddress + '.html"><i class="' + subchildNodesrow.Icon + '"></i>' + subchildNodesrow.FullName + '</a></li>';
								});
								_html += '</ul>';

							} else {
								_html += '<a class="menuItem" data-id="' + subrow.ModuleId + '" href="../..' + subrow.UrlAddress + '.html"><i class="' + subrow.Icon + '"></i>' + subrow.FullName + '</a>';
							}
							_html += '</li>';
						});
						_html += '</ul>';
