var viewModel = function() {
	...
	this.GetModuleTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUser/ModuleTreeJsonByCurrentUser",
			param:{
				userId: userId,
	...
	this.GetModuleButtonTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUser/ModuleButtonTreeJsonByCurrentUser",
			param:{
				userId: userId,
				category: options_val
			},
	...
	this.GetModuleColumnTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUser/ModuleColumnTreeJsonByCurrentUser",
			param:{
				userId: userId,
				category: options_val
			}
	...
	this.GetOrganizeTree = function() {
		cm.ajax({
			url: "/AuthorizeManage/PermissionUser/OrganizeTreeJsonByCurrentUser",
			data:{
				userId: userId
			},
			type: "GET",
