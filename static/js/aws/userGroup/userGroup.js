var viewModel = function() {
	...
	this.btn_add = function() {
		dialogOpen({
			id: "Form",
			title: '添加用户组',
			url: '/webpage/system/userGroup_form.html?keyValue=' + '',
			width: "500px",
			height: "360px",
	...
	this.btn_edit = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "Form",
				title: '修改用户组',
				url: '/webpage/system/userGroup_form.html?keyValue=' + keyValue,
				width: "500px",
				height: "360px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_member = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				...
				url: '/webpage/system/userGroup_allotMember.html?userGroupId=' + keyValue,
				width: "800px",
				height: "520px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_authorize = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				...
				url: '/webpage/system/userGroup_allotAuthorize.html?userGroupId=' + keyValue,
				width: "700px",
				height: "690px",
				btn: null
			});
