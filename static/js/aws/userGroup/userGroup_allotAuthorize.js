var viewModel = function() {
	...
	this.GetModuleTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUserGroup/ModuleTreeJsonByCurrentUser" ,
			param:{
	...
	this.GetModuleButtonTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUserGroup/ModuleButtonTreeJsonByCurrentUser" ,
			param:{
				userGroupId : userGroupId,
				category: options_val
			}
	...
	this.GetModuleColumnTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionUserGroup/ModuleColumnTreeJsonByCurrentUser" ,
			param:{
				userGroupId : userGroupId,
				category: options_val
			}
	...
	this.GetOrganizeTree = function() {
		cm.ajax({
			url: "/AuthorizeManage/PermissionUserGroup/OrganizeTreeJsonByCurrentUser" ,
			data:{
				userGroupId:userGroupId
			},
			type: "GET",
