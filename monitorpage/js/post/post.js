...
//	alert(companyId);
	...
	this.btn_add = function() {
		dialogOpen({
			id: "Form",
			title: '添加岗位',
			url: '/monitorpage/view/post/post_form.html',
			width: "500px",
			height: "360px",
	...
	this.btn_edit = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "Form",
				title: '修改岗位',
				url: '/monitorpage/view/post/post_form.html?keyValue=' + keyValue,
				width: "500px",
				height: "360px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_member = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "AllotMember",
				title: '岗位成员 - ' + FullName,
				url: '/monitorpage/view/post/post_allotMember.html?postId=' + keyValue,
				width: "800px",
				height: "520px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_authorize = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "AllotAuthorize",
				title: '岗位授权 - ' + FullName,
				url: '/monitorpage/view/post/post_allotAuthorize.html?postId=' + keyValue,
				width: "700px",
				height: "690px",
				btn: null
			});
