var viewModel = function() {
	var self = this;
	var procode = newrequest('procode');
	...
	this.initHtml = function(){
	    ...
	    iframeHtml += '<iframe id="iframe1" style="width:100%;height:100%;border:none;" src="../equiment/equitmentListBasic.html?id=0&code=' + procode + '" scrolling="no" frameborder="0" onload="Loading(false);"></iframe>' 
...
var iframe_url = [];
iframe_url.push("../equiment/equitmentListBasic.html?id=0&code=" + newrequest('procode'));
for(var j = 0 ; j < url_data.length; j++){
	var url_name = "../equiment/equitmentListTemplate.html?id=" + url_data[j].Node_Type + '&code=' + newrequest('procode');
