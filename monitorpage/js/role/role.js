...
//		$gridTable.authorizeColModel();
	...
	this.btn_add = function() {
		dialogOpen({
			id: "Form",
			title: '添加角色',
			url: '/monitorpage/view/role/role_form.html',
			width: "500px",
			height: "360px",
	...
	this.btn_edit = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "Form",
				title: '修改角色',
				url: '/monitorpage/view/role/role_form.html?keyValue=' + keyValue,
				width: "500px",
				height: "360px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_member = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "AllotMember",
				title: '角色成员 - ' + RoleName,
				url: '/monitorpage/view/role/role_allotMember.html?roleId=' + keyValue,
				width: "800px",
				height: "520px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
	...
	this.btn_authorize = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "AllotAuthorize",
				title: '角色授权 - ' + RoleName,
				url: '/monitorpage/view/role/role_allotAuthorize.html?roleId=' + keyValue,
				width: "700px",
				height: "690px",
				btn: null
			});
	...
	this.btn_ipfilter = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				...
				url: '/monitorpage/view/role/role_filterIP.html?objectId=' + keyValue + '&objectType=Role',
				width: "600px",
				height: "400px",
				btn: null
			});
	...
	this.btn_timefilter = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				...
				url: '/monitorpage/view/role/role_filterTime.html?objectId=' + keyValue + '&objectType=Role',
				width: "640px",
				height: "480px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
