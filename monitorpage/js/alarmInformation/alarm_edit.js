...
//		alert(keyValue)
	...
	this.AcceptClicksa = function() {
		var json_data = {};
		json_data.keyValue = ID;
		json_data.AlarmID = alarmItemID;
		json_data.ProcessPerson = $('#CreateUserName').val();
		json_data.ProcessDate =  $('#CreateDate').val();
		json_data.ProcessSuggest = $('#ProcessSuggest').val();
		json_data.ProcessStatus = $("#handle_statuS input[name='optionsRadiosinline']:checked").val();
//		var str = JSON.stringify(json_data);
//		alert(JSON.stringify(json_data))
		cm.ajax({
			url: '/AfterSaleManage/dm_processalarm/SaveForm',
			type: "POST",
			dataType: "json",
			data: json_data,
