var viewModel = function() {
	...
	this.initControl = function() {
		...
		$("#OrganizeTree").ComboBoxTree({
			url: "/BaseManage/Department/GetOrganizeTreeJson?OrganizeId=" + departmentId,
		...
		if(!!keyValue) {
			...
			if(sort == "Department") {
				$("#OrganizeTree").ComboBoxTreeSetValue(parentId);
				//加载负责人
				$("#ManagerId").ComboBoxTree({
					url: "/BaseManage/Department/GetUserTreeJson?DepartmentId=" + parentId,
					cbiconpath: "../../../static/lib/scripts/plugins/tree/images/icons/",
					description: "==请选择==",
					height: "220px",
					allowSearch: true
				...
				//加载负责人
				$("#ManagerId").ComboBoxTree({
					url: "/BaseManage/User/GetTreeJson?OrganizeId=" + parentId,
					param: {
						OrganizeId: sessionStorage.getItem("companyId")
					},
					cbiconpath: "../../../static/lib/scripts/plugins/tree/images/icons/",
