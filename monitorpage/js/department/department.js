var viewModel = function() {
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			url: "/BaseManage/Department/GetTreeListJsonToOrganize",
			datatype: "json",
			postData: {
	...
	this.btn_add = function() {
		...
		dialogOpen({
			id: "Form",
			title: '添加部门',
			url: '/monitorpage/view/department/department_form.html?organizeId=' + organizeId + '&parentId=' + parentId + '&sort=' + sort,
			width: "700px",
			height: "400px",
	...
	this.btn_edit = function() {
		...
		if(checkedRow(keyValue)) {
			...
			dialogOpen({
				id: "Form",
				title: '编辑部门',
				url: '/monitorpage/view/department/department_form.html?keyValue=' + keyValue,
				width: "700px",
				height: "400px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
