var viewModel = function() {
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			...
			url: "/AfterSaleManage/aw_qc_process/GetMyDutyJobListJson",
			datatype: "json",
			colModel: [{
					label: '序号',
					name: 'workinfoid',
	...
	this.btn_edit = function() {
		...
		var workstatus = $('#gridTable').jqGridRowValue('qa_status');
		var slseq = $('#gridTable').jqGridRowValue('slseq');
//		alert(slseq);
		if(checkedRow(keyValue)) {
				dialogOpenCommitForward({
					id: 'Form',
					url: '/hongtupage/view/responsibilityDeterminatioToDoList/toDoList_Form.html?keyValue=' + keyValue + '&slSeq=' + slseq,
					width: 'px',
					height: 'px',
					cancel: function() {
						//删除穿梭框session
