...
//				},
	...
	this.btn_add = function() {
		dialogOpen({
			id: "LogForm",
			title: '添加分类',
			url: '/hongtupage/view/product_attributes/default_bomForm.html?productInfoId=' + productInfoId + '&productCatId=' + productcatid,
			width: "500px",
			height: "400px",
	...
	this.btn_edit = function() {
		...
		if(checkedRow(keyValue)) {
			dialogOpen({
				id: "BtnForm",
				title: '编辑分类',
				url: '/hongtupage/view/product_attributes/default_bomForm.html?keyValue=' + keyValue+ '&productInfoId=' + productInfoId+ '&productCatId=' + productcatid,
				width: "500px",
				height: "400px",
				callBack: function(iframeId) {
					top.frames[iframeId].model.AcceptClick();
