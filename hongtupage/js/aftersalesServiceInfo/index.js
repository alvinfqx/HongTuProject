...
//服务类型参数
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			...
			url: "/AfterSaleManage/aw_AftersalesServiceInfo/GetPageListJson",
			datatype: "json",
			 colModel: [
	...
	this.btn_add = function() {
		dialogOpenContent({
			id: 'Form',
			url: '/AfterSaleManage/aw_AftersalesServiceInfo/Form',
			width: 'px',
			height: 'px',
	...
	this.btn_delete = function() {
		...
		if(keyValue) {
			$.RemoveForm({
				url: '/AfterSaleManage/aw_AftersalesServiceInfo/RemoveForm',
				param: {
					keyValue: keyValue
				},
