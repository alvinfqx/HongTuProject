var viewModel = function() {
	...
	this.GetModuleTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionRole/ModuleTreeJsonByCurrentUser",
	...
	this.GetModuleButtonTree = function() {
		var item = {
			height: 540,
			showcheck: true,
			url: "/AuthorizeManage/PermissionRole/ModuleButtonTreeJsonByCurrentUser",
			cbiconpath: "../../../static/lib/scripts/plugins/tree/images/icons/",
			param: {
				roleId: roleId,
				category: options_val
	...
	this.GetModuleColumnTree = function() {
		var item = {
			...
			url: "/AuthorizeManage/PermissionRole/ModuleColumnTreeJsonByCurrentUser",
			cbiconpath: "../../../static/lib/scripts/plugins/tree/images/icons/"
		};
	...
	this.GetOrganizeTree = function() {
		cm.ajax({
			url: "/AuthorizeManage/PermissionRole/OrganizeTreeJsonByCurrentUser",
			data: {
				roleId: roleId
			},
			type: "GET",
	...
	this.buttonOperation = function() {
		...
		$finish.click(function() {
			...
			$.SaveForm({
				url: "/AuthorizeManage/PermissionRole/SaveAuthorize",
				param: postData,
				loading: "正在保存角色授权...",
				success: function() {
