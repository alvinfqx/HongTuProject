    ...
    //加载表格
     this.GetGrid = function() {
        ...
        $gridTable.jqGrid({
            ...
            url: "/AfterSaleManage/aw_serviceInfo4Oper/GetPageListJson",
            datatype: "json",
            colModel: [
                ...
                { label: '工单状态', name: 'workStatus', index: 'workStatus', width: 80, align: 'center', sortable: true },
                { label: '信息来源', name: 'infoSource', index: 'infoSource', width: 80, align: 'center', sortable: true },
                { label: '客户单位', name: 'client', index: 'client', width: 150, align: 'center', sortable: true },
    ...
    //新增
     this.btn_add = function() {
        ...
        dialogOpenATECustomer({
            id: 'Form',
            title: '添加工作任务表',
            url: '/hongtupage/view/aw_serviceInfo4Oper/Form.html?keyValue=" "',
            width: 'px',
            height: 'px',
            cancel: function() {
						//删除穿梭框session
