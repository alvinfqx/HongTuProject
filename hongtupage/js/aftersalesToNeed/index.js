var viewModel = function() {
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			...
			url: "/AfterSaleManage/aw_AftersalesAssignedToNeed/GetPageListJson",
			datatype: "json",
			colModel: [{
					label: '序号',
					name: 'workInfoId',
	...
	this.btn_add = function() {
		dialogOpenContent({
			id: 'Form',
			url: '/hongtupage/view/aw_AftersalesAssignedToNeed/Form.html?keyValue=" "',
			width: 'px',
			height: 'px',
	...
	this.btn_delete = function() {
		...
		if(keyValue) {
			$.RemoveForm({
				url: '/AfterSaleManage/aw_AftersalesAssignedToNeed/RemoveForm',
				param: {
					keyValue: keyValue
				},
