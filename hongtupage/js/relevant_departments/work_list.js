    ...
    //加载表格
     this.GetGrid = function() {
        ...
        $gridTable.jqGrid({
            ...
            url: "/AfterSaleManage/aw_ServiceManageRequireList/GetPageListJson",
            datatype: "json",
            colModel: [
...
//      dialogOpenContent({
//          id: 'Form',
//          url: '/AfterSaleManage/aw_ServiceManageRequireList/Form',
//          width: 'px',
//          height: 'px',
...
//  }
    ...
    //删除
     this.btn_delete = function() {
        ...
        if (keyValue) {
            $.RemoveForm({
                url: '/AfterSaleManage/aw_ServiceManageRequireList/RemoveForm',
