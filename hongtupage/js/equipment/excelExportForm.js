var viewModel = function() {
	...
	$(function() {
		...
		var columnModel = self.parentIframe().$("#" + gridId).jqGrid('getGridParam', 'colModel');
		console.log($("#" + gridId,parent.document))
	...
	this.parentIframe = function() {
		return window.parent.document.getElementById("StatusForms").contentWindow;
	}
	//确定导出
	this.AcceptClick = function() {
		...
		html_form += cm.domain;
		html_form += "/Utility/ExecuteExportExcel' style='display:none;'>"
		var $form = $(html_form);
