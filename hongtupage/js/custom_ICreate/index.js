var viewModel = function() {
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			...
			url: "/AfterSaleManage/aw_CustomerTheNeedICreate/GetPageListJson",
			datatype: "json",
			colModel: [{
					label: '序号',
					name: 'workInfoId',
	...
	this.btn_add = function() {
		dialogOpenContent({
			id: 'Form',
			url: '/hongtupage/view/customerTheNeedICreate/Form.html?keyValue=" "',
			width: 'px',
			height: 'px',
	...
	this.btn_edit = function() {
		...
		/*  if (checkedRow(keyValue)) {
		      dialogOpenContent({
		          id: 'Form',
		          url: '/AfterSaleManage/aw_CustomerTheNeedICreate/Form?keyValue=' + keyValue,
		          width: 'px',
		          height: 'px',
		          callBack: function (iframeId) {
		              top.frames[iframeId].AcceptClick();
	...
	this.btn_delete = function() {
		...
		if(keyValue) {
			$.RemoveForm({
				url: '/AfterSaleManage/aw_CustomerTheNeedICreate/RemoveForm',
				param: {
					keyValue: keyValue
				},
