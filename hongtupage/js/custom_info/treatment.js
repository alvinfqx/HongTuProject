var viewModel = function(){
	...
	this.pageInit = function() {
		...
		$gridTable.jqGrid({
			url: "/AfterSaleManage/aw_CustomerAddNewRequire/GetDoorToDoorApointMentList", //组件创建完成之后请求数据的url
			postData: {
				productCatId:'',
			},
...
//		);
		...
		$("#btn_Search").click(function() {
			...
			$gridTable.jqGrid('setGridParam', {
				url: "/AfterSaleManage/aw_CustomerAddNewRequire/GetDoorToDoorApointMentList",
				postData: {
