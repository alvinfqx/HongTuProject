var viewModel = function(){
	...
	this.GetGrid = function() {
		...
		$gridTable.jqGrid({
			...
			url: "/Monitor/GetEquipmentArchives",
			datatype: "json",
			colModel: [{
					label: '序号',
					name: 'workinfoid',
	...
	var queryJson = {
			"cc_startTime": $("#cc_startTime").val(),
			"cc_endTime": $("#cc_endTime").val(), 
			"dg_startTime": $("#dg_startTime").val(), 
			"dg_endTime": $("#dg_endTime").val(),
			"zb_startTime": $("#zb_startTime").val(), 
			"zb_endTime": $("#zb_endTime").val(),
			"client": $("#client").val(), 
		...
		window.location= cm.domain +"/Monitor/GetEquipmentArchives?queryJson="+query+"&token="+cm.token;
		}
